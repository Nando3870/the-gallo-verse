...
while running:
    ...
    #The spaghetti
      ...
      #The plate and meatballs
          ...
          #More meatballs
        x_meatballs_nicholas = x-63

        while x_meatballs_nicholas < 127:
          ...
          x_meatballs_nicholas += 25 + 63 + 25

    #Cheese curds
        cheese_curds = []

        for i in range(40):
            cheese_x = random.randint(x + 155, y + 449) 
            cheese_y = random.randint(x + 100, y + 305) 
            cheese_curds.append([cheese_x, cheese_y])

        for curd in cheese_curds:
            curd[1] += 1  
            pygame.draw.circle(screen, (x + 255, y + 255, 0), (curd[0], curd[1]), 5) 
